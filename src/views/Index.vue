          ...
          <div class="w-full md:w-5/12 px-4 mr-auto ml-auto mt-32">
            ...
            >
              <img
                alt="..."
                :src="consultant"
                class="w-full align-middle rounded absolute shadow-lg max-w-210-px left-145-px -top-29-px z-3"
              />
              <img
                alt="..."
                :src="analyst"
              ...
              <img
                alt="..."
                :src="hacker_exposed_1"
                class="w-full align-middle rounded-lg absolute shadow-lg max-w-210-px left-40-px -top-225-px z-2"
              />
            </div>
          </div>
        </div>
...
import hacker_exposed_1 from "@/assets/img/hacker-exposed-1.png";
